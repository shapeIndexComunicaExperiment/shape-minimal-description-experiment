# Shape Index Solidbench Experiment with Comunica where the shapes contain minimal information

Experiments to benchmark solidbench queries using the shape index approach, where the shapes contained minimal information.
